...
#### 将圆labelme2YOLO 后的N行5列+N行3列的瓶口.txt信息转换为N 行7列的.txt ####
...
#### 将N行7列的信息画在图像上 ####
def draw_boxes_and_points(input_images_folder, input_labels_folder, output_folder, is_gen_seg_image=False):
        ...
        if label_filename.endswith(".txt"):
            ...
            for idx, label in enumerate(labels):
                ...
                if is_gen_seg_image == True: 
                    ...
                    image_seg_filename = os.path.splitext(label_filename)[0] + "_rect" + str(idx+1) + ".png"
...
if __name__ == "__main__":
    folder = "C:/Users/Eugene/Desktop/6DOF_data/0307_data_pro"
    is_pro_detect = False
    if is_pro_detect:
        input_folder_str = "/YOLODataset_det"
        output_folder_str = "/#3_bottle_detection"
        ...
        draw_boxes_and_points(output_images_folder, output_labels_folder, output_draw_folder, is_gen_seg_image=True)
        key_str = "/val"
        input_images_folder = folder + input_folder_str + "/images" + key_str
        input_labels_folder = folder + input_folder_str + "/labels" + key_str
        ...
        input_folder_str = "/YOLODataset_seg"
